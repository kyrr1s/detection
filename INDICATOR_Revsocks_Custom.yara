...
strings:
	...
	$p17 = "Start on the client: revsocks -listen :8080 -socks 127.0.0.1:1080 -pass test -tls" fullword ascii
	$p18 = "Start on the server: revsocks -connect client:8080 -pass test -tls" fullword ascii
	$p19 = "Connect to 127.0.0.1:1080 on the client with any socks5 client." fullword ascii
	$p20 = "Usage (dns):" fullword ascii
	$p21 = "Start on the DNS server: revsocks -dns example.com -dnslisten :53 -socks 127.0.0.1:1080" fullword ascii
	$p22 = "Start on the target: revsocks -dns example.com -pass <paste-generated-key>" fullword ascii
	$p23 = "Connect to 127.0.0.1:1080 on the DNS server with any socks5 client." fullword ascii
